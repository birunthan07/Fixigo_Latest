...
const AdminDashboard = () => {
  ...
  const cardColors = ['#153448', '#153448', '#153448', '#153448'];
    ...
    <div style={styles.container}>
      <aside style={styles.sidebar}>
        ...
        <nav>
          ...
          <Link to="/" style={{...styles.navItem, marginTop: 'auto', backgroundColor: '#2a9df4'}}>
            <FaSignOutAlt style={styles.navIcon} /> Logout
          </Link>
        </nav>
      </aside>
      ...
      <main style={styles.content}>
        ...
        {activeTab === 'dashboard' && (
          <div style={styles.cardContainer}>
            {[
              { icon: FaUsers, title: 'Total Users', value: stats.totalUsers },
              { icon: FaWrench, title: 'Total Mechanics', value: stats.totalMechanics },
              { icon: FaClipboardList, title: 'Total Requests', value: stats.totalRequests },
              { icon: FaMoneyBillWave, title: 'Total Payments', value: `$${stats.totalPayments.toFixed(2)}` },
            ].map((item, index) => (
              <div key={index} style={{...styles.card, backgroundColor: cardColors[index]}}>
                <item.icon style={styles.cardIcon} />
                ...
                <tr key={mechanic._id}>
                  ...
                  <td style={styles.tableCell}>
                    {!mechanic.isApproved && (
                      <button
                        onClick={() => approveMechanic(mechanic._id)}
                        style={{...styles.button, backgroundColor: '#2a9df4', color: 'white'}}
                      >
                        <FaCheckCircle style={{ marginRight: '5px' }} /> Approve
                      </button>
                    )}
                ...
                <tr key={user._id}>
                  ...
                  <td style={styles.tableCell}>
                    <button
                      ...
                      style={{
                        ...styles.button,
                        backgroundColor: user.isBanned ? '#2a9df4' : '#153448',
                        color: 'white',
                      }}
                    >
                      {user.isBanned ? <FaCheckCircle style={{ marginRight: '5px' }} /> : <FaBan style={{ marginRight: '5px' }} />}
